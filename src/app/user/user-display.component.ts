...
@Component({
    selector: 'list-display-user',
    templateUrl: './user-display.component.html',
    styleUrls: ['./user-display.component.css']
})
export class UserDisplayComponent implements OnInit, OnChanges {
    @Input() userId: number;
    @Input() user: IUser;   //use the @Input attribute to let the parent class/componenet pass information into 
    ...
    //  of the [routerLink] property without the "AppRoutingModule" inside the user.module.ts being enabled. when it is enable, as it was before,
    ...
    onUser_click(userNameToPassAsParameter) {
        //console.log('inside onUser_click');
        this._router.navigate(['/users/user', userNameToPassAsParameter]);
    }
}
